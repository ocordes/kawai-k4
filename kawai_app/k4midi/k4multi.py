...
class K4MultiInstrument(K4Base):
    ...
    sect2_rec_chan  = property(*K4Base.func_template(23, correct=1, mask=0b1111))
    ...
    sect2_transpose = property(*K4Base.func_template(26, correct=-24))
    sect2_tune      = property(*K4Base.func_template(27, correct=-50))
    ...
    sect3_rec_chan  = property(*K4Base.func_template(31, correct=1, mask=0b1111))
    ...
    sect3_transpose = property(*K4Base.func_template(34, correct=-24))
    sect3_tune      = property(*K4Base.func_template(35, correct=-50))
    ...
    sect4_rec_chan  = property(*K4Base.func_template(39, correct=1, mask=0b1111))
    ...
    sect4_transpose = property(*K4Base.func_template(42, correct=-24))
    sect4_tune      = property(*K4Base.func_template(43, correct=-50))
    ...
    sect5_rec_chan  = property(*K4Base.func_template(47, correct=1, mask=0b1111))
    ...
    sect5_transpose = property(*K4Base.func_template(50, correct=-24))
    sect5_tune      = property(*K4Base.func_template(51, correct=-50))
    ...
    sect6_rec_chan  = property(*K4Base.func_template(55, correct=1, mask=0b1111))
    ...
    sect6_transpose = property(*K4Base.func_template(58, correct=-24))
    sect6_tune      = property(*K4Base.func_template(59, correct=-50))
    ...
    sect7_rec_chan  = property(*K4Base.func_template(63, correct=1, mask=0b1111))
    ...
    sect7_transpose = property(*K4Base.func_template(66, correct=-24))
    sect7_tune      = property(*K4Base.func_template(67, correct=-50))
    ...
    sect8_rec_chan  = property(*K4Base.func_template(71, correct=1, mask=0b1111))
    ...
    sect8_transpose = property(*K4Base.func_template(74, correct=-24))
    sect8_tune      = property(*K4Base.func_template(75, correct=-50))